...
- Page Profil refaite en page d'identité/données sportives centralisées (2026-08-14, voir section 14) : identité, informations personnelles, fréquence cardiaque + zones Karvonen, zones RPE (repère fixe), préférences, seuils sport, connectivité, zone d'entraînement personnalisée (à venir), points de vigilance santé, sections avancées repliables, records, radar, résumé IA — gestion des courses retirée (déplacée sur Objectifs)
...
- `profil.html` — page "Profil" (refonte 2026-08-14, voir section 14) : identité + à propos, informations personnelles/FC/zones RPE, préférences/seuils sport/connectivité, zone d'entraînement personnalisée (à venir), points de vigilance santé, sections avancées repliables (`<details>`), records, radar de performance, résumé IA. Édition par carte (chaque carte a son propre bouton "Enregistrer", pas de formulaire global géant). Sidebar harmonisée avec l'Accueil. Pas de connexion Supabase obligatoire.
