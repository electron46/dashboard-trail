...
- Sidebar harmonisée (icône montagne + texte « ELEV », séparateur nav produit/compte, bloc utilisateur en bas) étendue à `historique.html`, `activite.html`, `analyse.html`, `objectifs.html`, `plan.html`, `profil.html` et `equipements.html` (2026-08-14) ; reste à faire sur `parametres.html`, seule page pas encore refaite — à harmoniser lors de sa refonte.
